...
\author{Kristine Lee}
\authornote{First because she wanted to take the lead on the paper.}
...
\author{Xing Li}
\authornote{Actually wrote TensorFlow code for this.}
...
Sketchy \cite{sketchy} and Learning What and Where to Draw \cite{whatWhereToDraw} are just a few things of interest.

\section{Implementation}
We used pix2pix to do magic tensor stuff.

\subsection{Training Set}
Training image tests 1, 2, 3.

\subsection{Cluster?}
Arthur tried stuff. Xing finished it.

\subsection{Web Interface}
Kristine did cool stuff.

\section{Discussion}
Stuff we did, stuff that worked, stuff Arthur said, but didn't do.
...
%% Template info for reference
% Original at https://www.overleaf.com/gallery/tagged/acm-official#.WQLlcvnyuUl
...
\begin{figure}
\includegraphics{9-outputs}
\caption{A sample black and white graphic.}
\end{figure}

\begin{figure}
\includegraphics[height=1in, width=1in]{9-outputs}
\caption{A sample black and white graphic
