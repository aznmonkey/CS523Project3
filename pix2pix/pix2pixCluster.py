...
def main():
    ...
    #if a.job_name != "single":
    print("CLUSTER:\tConfiguring setup")
    ...
    if a.job_name == "ps":
        ...
        server.join()
    elif a.job_name == "worker" or a.job_name == "single":
        if a.job_name == "worker":
            print("CLUSTER:\tRunning as worker " + str(a.task_index))
            
            # Assigns ops to the local worker by default.
            with tf.device(tf.train.replica_device_setter(
            #worker_device="/job:worker/task:%d" % a.task_index,
                worker_device="/job:worker/task:%d" % a.task_index,
                cluster=cluster)):
